...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'Back Dated Testing should be failed')

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/button_Book Appointment'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_CURA Healthcare Service/Date'), [('DATE'):now])

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/p_31102023'))
